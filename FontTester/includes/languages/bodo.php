<div style="width: 90%;" lang="brx" contenteditable="true">
	...
	<p class="sizelabel">Headline <span style="font-weight:bold;"><span id="changedfontsizeBodo1">72</span>px / <span id="changedlineheightBodo1">1.2</span>em</span></p><br/>
		...
		<div class="dontprint">
			<input type="range" min="12" max="100" value="72" step="1" oninput="changeFontSizeBodo1(this.value)" onchange="changeFontSizeBodo1(this.value)" style="width: 300px;" />
			<input type="range" min="0.6" max="2" value="1.2" step="0.05" oninput="changeLineHeightBodo1(this.value)" onchange="changeLineHeightBodo1(this.value)" style="width: 125px;" />
			<script type="text/javascript">
				function changeFontSizeBodo1(newValue) {
					document.getElementById("changedfontsizeBodo1").innerHTML=newValue;
					$('.changesizeBodo1').css('font-size',newValue + 'px');
				};
				function changeLineHeightBodo1(newValue) {
					document.getElementById("changedlineheightBodo1").innerHTML=newValue;
					$('.changesizeBodo1').css('line-height',newValue);
				};
			</script>
		</div>
		<br />
	...
	<p class="sizelabel">Word List in Bodo <span style="font-weight:bold;"><span id="changedfontsizeBodo2">45</span>px / <span id="changedlineheightBodo2">1.2</span>em</span></p><br/>

		<div class="dontprint">
			<input type="range" min="12" max="100" value="45" step="1" oninput="changeFontSizeBodo2(this.value)" onchange="changeFontSizeBodo2(this.value)" style="width: 300px;" />
			<input type="range" min="0.6" max="2" value="1.2" step="0.05" oninput="changeLineHeightBodo2(this.value)" onchange="changeLineHeightBodo2(this.value)" style="width: 125px;" />
			<script type="text/javascript">
				function changeFontSizeBodo2(newValue) {
					document.getElementById("changedfontsizeBodo2").innerHTML=newValue;
					$('.changesizeBodo2').css('font-size',newValue + 'px');
				};
				function changeLineHeightBodo2(newValue) {
					document.getElementById("changedlineheightBodo2").innerHTML=newValue;
					$('.changesizeBodo2').css('line-height',newValue);
				};
			</script>
		</div>

	<p class="changesizeBodo2" style="font-size: 45px; line-height: 120%;">
